              ...
              {selectedTransportType === 'domestic' && (
                <Box sx={{
                  ...
                  <Box sx={{ flex: '0 0 60%' }}>
                    ...
                    <Typography variant="body2" sx={{ fontSize: '0.65rem', mb: 1, fontFamily: 'Sarabun, Arial, sans-serif' }}>
                      (ค) ความเสียหายของสินค้า กรณีที่รถขนส่งสินค้าเกิดอุบัติเหตุที่เป็นสาเหตุของสินค้าเสียหาย ในกรณีที่ไม่พบปัญหา ให้คะแนน = 3 คะแนน , กรณีที่พบปัญหา 1 ครั้งใน 1 เดือน ค่าเสียหายไม่เกิน 300,000 บาท ให้ 1 คะแนน กรณีที่พบปัญหาข้างต้นมากกว่า 1 ครั้ง/เดือน หรือมีความเสียหายมากกว่า 300,000 บาท ให้ = 0 คะแนน
                    </Typography>
                  </Box>
